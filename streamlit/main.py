...
st.pyplot(fig3)
st.write('Sesuai dengan grafik yang sudah dibuat, ada lebih banyak pelanggan di bagian tenggara dan selatan. Informasi lainnya, ada lebih banyak pelanggan di kota-kota yang merupakan ibu kota (São Paulo, Rio de Janeiro, Porto Alegre, dan lainnya.)Jadi intinya aktivitas pelanggan lebih tinggi di wilayah-wilayah tersebut.')
